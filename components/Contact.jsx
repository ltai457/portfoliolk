...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "ef8e4f0f-7609-4a2b-a8db-f37ae3495ef3");
      ...
      >
        ...
        {result && (
          <motion.p 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className={`mt-4 text-center ${result.includes("Success") ? "text-green-600" : result.includes("error") ? "text-red-600" : ""}`}
          >
            {result}
          </motion.p>
        )}
